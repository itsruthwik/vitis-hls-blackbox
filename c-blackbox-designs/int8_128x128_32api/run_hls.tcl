# Design parameters (pre-configured for int8_128x128_32api)
set design_dir [file normalize [info script]/..] 
set design_name "matrix_multiply_128x128_32api"
set cpp_file "matrix_multiply_128x128_32api.cpp"
set tb_file "matrix_multiply_128x128_32api_tb.cpp"

# 32x32 wrapper files from c-api-library (no 128x128 wrapper needed!)
set wrapper_cpp "../../c-api-library/int8_32x32/int8_32x32_wrapper.cpp"
set wrapper_json "../../c-api-library/int8_32x32/int8_32x32_wrapper.json"
...
# Add 32x32 wrapper behavioral model and blackbox JSON
