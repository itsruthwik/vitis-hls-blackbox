/*
 * matrix_multiply_128x128_32api_tb.cpp
 * Testbench for 128x128 matrix multiplication using 32x32 wrapper tiles
 */
...
int main() {
    ...
    printf("Starting 128x128 matrix multiplication tests (using 32x32 API tiles)...\n");
    ...
    // Run the computation
    matrix_multiply_128x128_32api(A, B, C);
