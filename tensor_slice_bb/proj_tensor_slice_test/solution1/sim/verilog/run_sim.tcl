...
if {[file isfile tensor_slice_test.autotvin.dat]} {
	file delete -force tensor_slice_test.autotvin.dat
}

if {[file isfile tensor_slice_test.autotvout.dat]} {
	file delete -force tensor_slice_test.autotvout.dat
}
