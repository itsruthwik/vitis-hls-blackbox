...
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := /opt/AMD/Vitis_HLS/2024.1/vcxx/libexec/
TOOLCHAIN += --gcc-toolchain=/opt/AMD/Vitis_HLS/2024.1/tps/lnx64/gcc-8.3.0
...
$(ObjDir)/tensor_slice_test_tb.cpp_pre.cpp.tb.o : tensor_slice_test_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tensor_slice_test_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/tensor_slice_wrapper.cpp_pre.cpp.tb.o : tensor_slice_wrapper.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tensor_slice_wrapper.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/tensor_slice_test.cpp_pre.cpp.tb.o : tensor_slice_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tensor_slice_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
