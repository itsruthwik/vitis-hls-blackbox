...
# VTR Flow Runner for int8_8x8 design
# Runs VTR synthesis, packing, placement, and routing on HLS-generated Verilog

set -e

# Hardcoded paths
DESIGN_NAME="int8_8x8"
TOP_MODULE="matrix_multiply_8x8"

ROOT="/mnt/vault0/rsunketa/vitis-hls-blackbox"
SCRIPT_DIR="${ROOT}/no-bb-beh/${DESIGN_NAME}"
...
echo "Running VTR flow for int8_8x8..."
