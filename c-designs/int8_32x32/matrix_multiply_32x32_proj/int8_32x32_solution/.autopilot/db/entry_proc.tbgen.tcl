...
set portList { 
	...
	{ C_c_num_data_valid sc_in sc_lv 4 signal 1 } 
	{ C_c_fifo_cap sc_in sc_lv 4 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "C_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "5", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	C_c { ap_fifo {  { C_c_din fifo_data_in 1 64 }  { C_c_num_data_valid fifo_status_num_data_valid 0 4 }  { C_c_fifo_cap fifo_update 0 4 }  { C_c_full_n fifo_status 0 1 }  { C_c_write fifo_port_we 1 1 } } }
}
