set moduleName Loop_VITIS_LOOP_47_1_proc1
set isTopModule 0
...
set C_modelName {Loop_VITIS_LOOP_47_1_proc1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem_a int 8 regular {axi_master 0}  }
	{ A int 64 regular  }
	{ a_stream int 128 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem_a", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "A","offset": { "type": "dynamic","port_name": "A","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "a_stream", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ a_stream_din sc_out sc_lv 128 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "a_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "a_stream", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	a_stream { ap_fifo {  { a_stream_din fifo_data_in 1 128 }  { a_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { a_stream_fifo_cap fifo_update 0 3 }  { a_stream_full_n fifo_status 0 1 }  { a_stream_write fifo_port_we 1 1 } } }
}
