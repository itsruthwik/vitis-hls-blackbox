...
__attribute__((sdx_kernel("matrix_multiply_16x16", 0))) void matrix_multiply_16x16(
    ap_int<8> A[16][16],
    ap_int<8> B[16][16],
    ap_int<16> C[16][16]
);
# 8 "matrix_multiply_16x16.cpp" 2
...
{
#line 34 "/mnt/vault0/rsunketa/vitis-hls-blackbox/c-designs/int8_16x16/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=matrix_multiply_16x16
# 25 "matrix_multiply_16x16.cpp"
...
#pragma HLS dataflow
 {
        ...
        VITIS_LOOP_47_1: for (int i = 0; i < 16; i++) {
            ap_uint<128> row_a = 0;
            VITIS_LOOP_49_2: for (int j = 0; j < 16; j++) {
        ...
        VITIS_LOOP_57_3: for (int j = 0; j < 16; j++) {
            ap_uint<128> col_b = 0;
            VITIS_LOOP_59_4: for (int i = 0; i < 16; i++) {
        ...
        VITIS_LOOP_70_5: for (int i = 0; i < 16; i++) {
            ap_uint<256> row_c = c_stream.read();
            VITIS_LOOP_72_6: for (int j = 0; j < 16; j++) {
