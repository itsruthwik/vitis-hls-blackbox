# 1 "../../library/int8_16x16/int8_16x16_wrapper.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../library/int8_16x16/int8_16x16_wrapper.cpp" 2
...
# 2 "../../library/int8_16x16/int8_16x16_wrapper.cpp" 2
...
# 3 "../../library/int8_16x16/int8_16x16_wrapper.cpp" 2
...
#pragma HLS interface ap_ctrl_none port=return
 ...
 ap_uint<128> a_data[16];
    VITIS_LOOP_19_1: for(int i = 0; i < 16; i++) {
#pragma HLS unroll
 a_data[i] = a_stream.read();
    ...
    VITIS_LOOP_27_2: for(int i = 0; i < 16; i++) {
#pragma HLS unroll
 b_data[i] = b_stream.read();
    ...
    VITIS_LOOP_38_3: for(int i = 0; i < 16; i++) {
        VITIS_LOOP_39_4: for(int j = 0; j < 16; j++) {
            a_mat[i][j] = a_data[i]((j+1)*8-1, j*8);
        }
    }


    VITIS_LOOP_45_5: for(int i = 0; i < 16; i++) {
        VITIS_LOOP_46_6: for(int j = 0; j < 16; j++) {
    ...
    VITIS_LOOP_53_7: for(int i = 0; i < 16; i++) {
        VITIS_LOOP_54_8: for(int j = 0; j < 16; j++) {
            VITIS_LOOP_55_9: for(int k = 0; k < 16; k++) {
    ...
    VITIS_LOOP_63_10: for(int row = 0; row < 16; row++) {
#pragma HLS unroll
 ap_uint<256> c_row = 0;
        VITIS_LOOP_66_11: for(int col = 0; col < 16; col++) {
