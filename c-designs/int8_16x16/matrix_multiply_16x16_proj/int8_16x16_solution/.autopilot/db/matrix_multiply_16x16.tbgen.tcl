set moduleName matrix_multiply_16x16
set isTopModule 1
...
set C_modelName {matrix_multiply_16x16}
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"matrix_multiply_16x16","role":"start","value":"0","valid_bit":"0"},{"name":"matrix_multiply_16x16","role":"continue","value":"0","valid_bit":"4"},{"name":"matrix_multiply_16x16","role":"auto_start","value":"0","valid_bit":"7"},{"name":"A","role":"data","value":"16"},{"name":"B","role":"data","value":"28"},{"name":"C","role":"data","value":"40"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"matrix_multiply_16x16","role":"start","value":"0","valid_bit":"0"},{"name":"matrix_multiply_16x16","role":"done","value":"0","valid_bit":"1"},{"name":"matrix_multiply_16x16","role":"idle","value":"0","valid_bit":"2"},{"name":"matrix_multiply_16x16","role":"ready","value":"0","valid_bit":"3"},{"name":"matrix_multiply_16x16","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "8", "10", "12", "14", "15", "16", "17", "18", "19"],
		"CDFG" : "matrix_multiply_16x16",
		"Protocol" : "ap_ctrl_hs",
		...
		"InputProcess" : [
			...
			{"ID" : "6", "Name" : "Loop_VITIS_LOOP_47_1_proc1_U0"},
			{"ID" : "8", "Name" : "Loop_VITIS_LOOP_57_3_proc2_U0"}],
		"OutputProcess" : [
			{"ID" : "12", "Name" : "Loop_VITIS_LOOP_70_5_proc3_U0"}],
		"Port" : [
			{"Name" : "gmem_a", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "Loop_VITIS_LOOP_47_1_proc1_U0", "Port" : "gmem_a"}]},
			{"Name" : "gmem_b", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "Loop_VITIS_LOOP_57_3_proc2_U0", "Port" : "gmem_b"}]},
			{"Name" : "gmem_c", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "12", "SubInstance" : "Loop_VITIS_LOOP_70_5_proc3_U0", "Port" : "gmem_c"}]},
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.entry_proc_U0", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "C", "Type" : "None", "Direction" : "I"},
			{"Name" : "C_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["12"], "DependentChan" : "14", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "C_c_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Loop_VITIS_LOOP_47_1_proc1_U0", "Parent" : "0", "Child" : ["7"],
		"CDFG" : "Loop_VITIS_LOOP_47_1_proc1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		...
		"Port" : [
			...
			{"Name" : "A", "Type" : "None", "Direction" : "I"},
			{"Name" : "a_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["10","11"], "DependentChan" : "15", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_VITIS_LOOP_47_1_proc1_U0.flow_control_loop_pipe_U", "Parent" : "6"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Loop_VITIS_LOOP_57_3_proc2_U0", "Parent" : "0", "Child" : ["9"],
		"CDFG" : "Loop_VITIS_LOOP_57_3_proc2",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "b_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["10","11"], "DependentChan" : "16", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "b_stream_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_57_3", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "16", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage9", "LastStateIter" : "ap_enable_reg_pp0_iter1", "LastStateBlock" : "ap_block_pp0_stage9_subdone", "QuitState" : "ap_ST_fsm_pp0_stage9", "QuitStateIter" : "ap_enable_reg_pp0_iter1", "QuitStateBlock" : "ap_block_pp0_stage9_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "1"}}]},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_VITIS_LOOP_57_3_proc2_U0.flow_control_loop_pipe_U", "Parent" : "8"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.int8_16x16_wrapper_wrapper_1_U0", "Parent" : "0", "Child" : ["11"],
		"CDFG" : "int8_16x16_wrapper_wrapper_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "Dataflow", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "1",
		"II" : "0",
		...
		"IsBlackBox" : "0",
		"StartSource" : "6",
		"StartFifo" : "start_for_int8_16x16_wrapper_wrapper_1_U0_U",
		"InputProcess" : [
			{"ID" : "11", "Name" : "int8_16x16_wrapper_U0"}],
		"OutputProcess" : [
			{"ID" : "11", "Name" : "int8_16x16_wrapper_U0"}],
		"Port" : [
			{"Name" : "a_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["6"], "DependentChan" : "15", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "int8_16x16_wrapper_U0", "Port" : "a_stream"}]},
			{"Name" : "b_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["8"], "DependentChan" : "16", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "int8_16x16_wrapper_U0", "Port" : "b_stream"}]},
			{"Name" : "c_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["12"], "DependentChan" : "17", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "int8_16x16_wrapper_U0", "Port" : "c_stream"}]}]},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.int8_16x16_wrapper_wrapper_1_U0.int8_16x16_wrapper_U0", "Parent" : "10",
		"CDFG" : "int8_16x16_wrapper",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		...
		"Port" : [
			...
			{"Name" : "b_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["8"], "DependentChan" : "16", "DependentChanDepth" : "2", "DependentChanType" : "0"},
			{"Name" : "c_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["12"], "DependentChan" : "17", "DependentChanDepth" : "2", "DependentChanType" : "0"}]},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Loop_VITIS_LOOP_70_5_proc3_U0", "Parent" : "0", "Child" : ["13"],
		...
		"Port" : [
			{"Name" : "C", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["5"], "DependentChan" : "14", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
			...
			{"Name" : "c_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["10","11"], "DependentChan" : "17", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "13", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_VITIS_LOOP_70_5_proc3_U0.flow_control_loop_pipe_U", "Parent" : "12"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.C_c_U", "Parent" : "0"},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.a_stream_U", "Parent" : "0"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.b_stream_U", "Parent" : "0"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.c_stream_U", "Parent" : "0"},
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_Loop_VITIS_LOOP_70_5_proc3_U0_U", "Parent" : "0"},
	{"ID" : "19", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_int8_16x16_wrapper_wrapper_1_U0_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	matrix_multiply_16x16 {
		gmem_a {Type I LastRead 24 FirstWrite -1}
		gmem_b {Type I LastRead 24 FirstWrite -1}
	...
	Loop_VITIS_LOOP_47_1_proc1 {
		gmem_a {Type I LastRead 24 FirstWrite -1}
		A {Type I LastRead 0 FirstWrite -1}
		a_stream {Type O LastRead -1 FirstWrite 25}}
	Loop_VITIS_LOOP_57_3_proc2 {
		B {Type I LastRead 0 FirstWrite -1}
		gmem_b {Type I LastRead 24 FirstWrite -1}
		b_stream {Type O LastRead -1 FirstWrite 25}}
	int8_16x16_wrapper_wrapper_1 {
