set moduleName Loop_VITIS_LOOP_57_3_proc2
set isTopModule 0
...
set C_modelName {Loop_VITIS_LOOP_57_3_proc2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ B int 64 regular  }
	{ gmem_b int 8 regular {axi_master 0}  }
	{ b_stream int 128 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "B", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "b_stream", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ b_stream_din sc_out sc_lv 128 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "b_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "b_stream", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	b_stream { ap_fifo {  { b_stream_din fifo_data_in 1 128 }  { b_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { b_stream_fifo_cap fifo_update 0 3 }  { b_stream_full_n fifo_status 0 1 }  { b_stream_write fifo_port_we 1 1 } } }
}
