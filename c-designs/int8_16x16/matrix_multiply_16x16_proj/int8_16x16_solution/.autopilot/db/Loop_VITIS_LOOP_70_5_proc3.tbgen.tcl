...
set C_modelArgList {
	...
	{ c_stream int 256 regular {fifo 0 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "C", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "c_stream", "interface" : "fifo", "bitwidth" : 256, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ c_stream_dout sc_in sc_lv 256 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "c_stream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "c_stream", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	...
	c_stream { ap_fifo {  { c_stream_dout fifo_data_in 0 256 }  { c_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { c_stream_fifo_cap fifo_update 0 3 }  { c_stream_empty_n fifo_status 0 1 }  { c_stream_read fifo_port_we 1 1 } } }
}
