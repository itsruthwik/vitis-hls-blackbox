...
module matrix_multiply_8x8_Loop_VITIS_LOOP_45_1_proc1 (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg    a_stream_blk_n;
reg   [63:0] gmem_a_addr_reg_151;
reg    ap_done_reg;
reg    ap_block_state1_pp0_stage0_iter0;
reg    ap_block_state17_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_11001;
reg   [0:0] icmp_ln45_reg_157;
reg    ap_block_pp0_stage7_11001;
reg   [0:0] icmp_ln45_reg_157_pp0_iter1_reg;
reg   [7:0] gmem_a_addr_read_reg_161;
reg    ap_block_state2_io;
reg    ap_block_state10_pp0_stage1_iter1;
reg    ap_block_state18_pp0_stage1_iter2;
reg    ap_block_pp0_stage1_11001;
reg   [7:0] gmem_a_addr_read_1_reg_166;
reg    ap_block_state11_pp0_stage2_iter1;
reg    ap_block_pp0_stage2_11001;
reg   [7:0] gmem_a_addr_read_2_reg_171;
reg    ap_block_state12_pp0_stage3_iter1;
reg    ap_block_pp0_stage3_11001;
reg   [7:0] gmem_a_addr_read_3_reg_176;
reg    ap_block_state13_pp0_stage4_iter1;
reg    ap_block_pp0_stage4_11001;
reg   [7:0] gmem_a_addr_read_4_reg_181;
reg    ap_block_state14_pp0_stage5_iter1;
reg    ap_block_pp0_stage5_11001;
reg   [7:0] gmem_a_addr_read_5_reg_186;
reg    ap_block_state15_pp0_stage6_iter1;
reg    ap_block_pp0_stage6_11001;
reg   [7:0] gmem_a_addr_read_6_reg_191;
reg   [7:0] gmem_a_addr_read_7_reg_196;
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2) & (1'b0 == ap_block_pp0_stage2_11001))) begin
        gmem_a_addr_read_1_reg_166 <= m_axi_gmem_a_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage3) & (1'b0 == ap_block_pp0_stage3_11001))) begin
        gmem_a_addr_read_2_reg_171 <= m_axi_gmem_a_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage4) & (1'b0 == ap_block_pp0_stage4_11001))) begin
        gmem_a_addr_read_3_reg_176 <= m_axi_gmem_a_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage5) & (1'b0 == ap_block_pp0_stage5_11001))) begin
        gmem_a_addr_read_4_reg_181 <= m_axi_gmem_a_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage6) & (1'b0 == ap_block_pp0_stage6_11001))) begin
        gmem_a_addr_read_5_reg_186 <= m_axi_gmem_a_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7) & (1'b0 == ap_block_pp0_stage7_11001))) begin
        gmem_a_addr_read_6_reg_191 <= m_axi_gmem_a_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        gmem_a_addr_read_7_reg_196 <= m_axi_gmem_a_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001))) begin
        gmem_a_addr_read_reg_161 <= m_axi_gmem_a_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        gmem_a_addr_reg_151 <= A;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage7) & (1'b0 == ap_block_pp0_stage7_11001))) begin
        icmp_ln45_reg_157 <= icmp_ln45_fu_120_p2;
        icmp_ln45_reg_157_pp0_iter1_reg <= icmp_ln45_reg_157;
    end
end
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage7) & (icmp_ln45_fu_120_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage7_subdone))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln45_reg_157_pp0_iter1_reg == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_subdone))) begin
...
assign a_stream_din = row_a_fu_131_p9;
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state17_pp0_stage0_iter2)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state17_pp0_stage0_iter2)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_block_state1_pp0_stage0_iter0)));
end
...
always @ (*) begin
    ap_block_pp0_stage1_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state18_pp0_stage1_iter2)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_block_state2_io)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state10_pp0_stage1_iter1)));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state18_pp0_stage1_iter2)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_block_state2_io)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state10_pp0_stage1_iter1)));
end

assign ap_block_pp0_stage2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage2_11001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state11_pp0_stage2_iter1)));
end

always @ (*) begin
    ap_block_pp0_stage2_subdone = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state11_pp0_stage2_iter1)));
end
...
always @ (*) begin
    ap_block_state10_pp0_stage1_iter1 = (m_axi_gmem_a_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state11_pp0_stage2_iter1 = (m_axi_gmem_a_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state12_pp0_stage3_iter1 = (m_axi_gmem_a_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state13_pp0_stage4_iter1 = (m_axi_gmem_a_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state14_pp0_stage5_iter1 = (m_axi_gmem_a_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state15_pp0_stage6_iter1 = (m_axi_gmem_a_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state16_pp0_stage7_iter1 = (m_axi_gmem_a_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state17_pp0_stage0_iter2 = (m_axi_gmem_a_RVALID == 1'b0);
end

always @ (*) begin
    ap_block_state18_pp0_stage1_iter2 = (1'b0 == a_stream_full_n);
end
...
always @ (*) begin
    ap_condition_472 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln45_reg_157 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001));
end

always @ (*) begin
    ap_condition_475 = ((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001));
end
...
assign i_fu_114_p2 = (i1_fu_58 + 3'd1);

assign icmp_ln45_fu_120_p2 = ((i1_fu_58 == 3'd7) ? 1'b1 : 1'b0);

assign m_axi_gmem_a_ARADDR = gmem_a_addr_reg_151;
...
assign m_axi_gmem_a_ARLEN = 64'd64;
...
assign row_a_fu_131_p9 = {{{{{{{{gmem_a_addr_read_7_reg_196}, {gmem_a_addr_read_6_reg_191}}, {gmem_a_addr_read_5_reg_186}}, {gmem_a_addr_read_4_reg_181}}, {gmem_a_addr_read_3_reg_176}}, {gmem_a_addr_read_2_reg_171}}, {gmem_a_addr_read_1_reg_166}}, {gmem_a_addr_read_reg_161}};

assign start_out = real_start;

endmodule //matrix_multiply_8x8_Loop_VITIS_LOOP_45_1_proc1
