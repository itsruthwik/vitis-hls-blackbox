...
entity matrix_multiply_8x8_fifo_w64_d2_S is 
    generic (
...
architecture rtl of matrix_multiply_8x8_fifo_w64_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component matrix_multiply_8x8_fifo_w64_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_matrix_multiply_8x8_fifo_w64_d2_S_ShiftReg : matrix_multiply_8x8_fifo_w64_d2_S_ShiftReg
    generic map (
...
entity matrix_multiply_8x8_fifo_w64_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end matrix_multiply_8x8_fifo_w64_d2_S_ShiftReg;

architecture rtl of matrix_multiply_8x8_fifo_w64_d2_S_ShiftReg is
