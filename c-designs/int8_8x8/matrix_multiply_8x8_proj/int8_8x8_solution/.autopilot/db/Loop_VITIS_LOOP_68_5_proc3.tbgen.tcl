set moduleName Loop_VITIS_LOOP_68_5_proc3
set isTopModule 0
...
set C_modelName {Loop_VITIS_LOOP_68_5_proc3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ C int 64 regular {fifo 0}  }
	{ gmem_c int 16 regular {axi_master 1}  }
	{ c_stream int 128 regular {fifo 0 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "C", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "c_stream", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ C_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ C_fifo_cap sc_in sc_lv 3 signal 0 } 
	{ C_empty_n sc_in sc_logic 1 signal 0 } 
	{ C_read sc_out sc_logic 1 signal 0 } 
	{ c_stream_dout sc_in sc_lv 128 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "c_stream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "c_stream", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	...
	c_stream { ap_fifo {  { c_stream_dout fifo_data_in 0 128 }  { c_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { c_stream_fifo_cap fifo_update 0 3 }  { c_stream_empty_n fifo_status 0 1 }  { c_stream_read fifo_port_we 1 1 } } }
}
