...
# 2 "<built-in>" 2
# 1 "matrix_multiply_8x8.cpp" 2





# 1 "./matrix_multiply_8x8.h" 1
...
__attribute__((sdx_kernel("matrix_multiply_8x8", 0))) void matrix_multiply_8x8(
    ap_int<8> A[8][8],
    ap_int<8> B[8][8],
    ap_int<16> C[8][8]
);
# 7 "matrix_multiply_8x8.cpp" 2
...
#line 36 "/mnt/vault0/rsunketa/vitis-hls-blackbox/c-designs/int8_8x8/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=matrix_multiply_8x8
# 23 "matrix_multiply_8x8.cpp"
...
#pragma HLS dataflow
 {
        ...
        VITIS_LOOP_45_1: for (int i = 0; i < 8; i++) {
            ap_uint<64> row_a = 0;
        ...
        VITIS_LOOP_55_3: for (int j = 0; j < 8; j++) {
            ap_uint<64> col_b = 0;
            VITIS_LOOP_57_4: for (int i = 0; i < 8; i++) {
        ...
        VITIS_LOOP_68_5: for (int i = 0; i < 8; i++) {
            ap_uint<128> row_c = c_stream.read();
            VITIS_LOOP_70_6: for (int j = 0; j < 8; j++) {
