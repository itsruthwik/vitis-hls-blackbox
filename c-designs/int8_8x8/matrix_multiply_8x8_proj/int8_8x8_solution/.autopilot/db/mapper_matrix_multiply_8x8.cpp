...
using hls::sim::Byte;
extern "C" void matrix_multiply_8x8(Byte<1>*, Byte<1>*, Byte<2>*, int, int, int);
extern "C" void apatb_matrix_multiply_8x8_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, volatile void * __xlx_apatb_param_C) {
...
__xlx_C__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_C)[i]);
  ...
  // DUT call
  matrix_multiply_8x8(__xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_C__tmp_vec.data(), __xlx_offset_byte_param_A, __xlx_offset_byte_param_B, __xlx_offset_byte_param_C);
