...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_C \
    op interface \
    ports { C_dout { I 64 vector } C_num_data_valid { I 3 vector } C_fifo_cap { I 3 vector } C_empty_n { I 1 bit } C_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { c_stream_dout { I 128 vector } c_stream_num_data_valid { I 3 vector } c_stream_fifo_cap { I 3 vector } c_stream_empty_n { I 1 bit } c_stream_read { O 1 bit } } \
} "
}
